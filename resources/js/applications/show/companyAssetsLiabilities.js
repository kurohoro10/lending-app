...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // After the accordion listener, initialise currency inputs
    initCurrencyInput('cal-asset-value-display', 'cal-asset-value', { min: 0 });
    initCurrencyInput('cal-liability-value-display', 'cal-liability-value', { min: 0 });
    ...
    function resetForm(type) {
        ...
        document.getElementById(`${prefix}-value`).value         = '';   // hidden
        document.getElementById(`${prefix}-value-display`).value = '';   // display
        clearErrors(type);
    }
