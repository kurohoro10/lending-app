...
<div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl mb-6 border border-gray-200">
    ...
    <div class="p-6">
        ...
        <div id="employment-messages" class="mb-4" role="status" aria-live="polite"></div>
                ...
                <div id="employment-list">
                    ...
                    <div class="employment-item p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl border border-gray-200 hover:shadow-md transition" data-employment-id="{{ $employment->id }}">
                        <div class="flex justify-between items-start">
                            ...
                            <button type="button"
                                    onclick="deleteEmployment({{ $application->id }}, {{ $employment->id }})"
...
<script>
    Object.assign(window.EMPLOYMENT_CONFIG, {
        deleteRoute: @js(route('applications.documents.destroy', [$application, ':id']))
    });
</script>
