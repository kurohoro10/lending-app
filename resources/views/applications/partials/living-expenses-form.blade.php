...
<div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl mb-6 border border-gray-200">
    ...
    <div class="p-6">
        ...
        <div id="expense-messages" class="mb-4"></div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="expenses-tbody" class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="expense-row hover:bg-gray-50 transition" data-expense-id="{{ $expense->id }}">
                                ...
                                <td class="px-6 py-4 text-right whitespace-nowrap">
                                    <button type="button"
                                            onclick="deleteExpense({{ $application->id }}, {{ $expense->id }})"
