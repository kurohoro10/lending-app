...
{{--
    Replaces bank-statements-iframe.blade.php (CreditSense).
    The Basiq UI SDK renders into #basiq-ui-container via JS — no iframe needed.
    This partial is included lazily (only when the user clicks "Connect My Bank").
--}}

<div class="border border-gray-200 rounded-xl overflow-hidden">

    {{-- Loading state — visible while the Basiq SDK initialises --}}
    <div id="basiq-loading"
    ...
    {{-- Basiq UI SDK renders here — hidden until SDK is ready --}}
    <div id="basiq-ui-container"
         class="hidden"
         style="min-height: 580px;"
         role="region"
         aria-label="Basiq bank connection — select your bank and follow the on-screen instructions to securely share read-only access to your transaction history."
         tabindex="-1">
    </div>

    {{-- SDK error state — shown by JS if the SDK fails to load --}}
    <div id="basiq-sdk-error"
         class="hidden flex flex-col items-center justify-center py-8 px-6 text-center"
         role="alert"
         aria-live="assertive">
        ...
        <p class="text-sm text-gray-500 mt-1">
            Please check your internet connection and refresh the page, or contact us if the issue persists.
        </p>
        <button type="button"
