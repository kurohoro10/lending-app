{{-- resources/views/applications/loan-deed.blade.php — client review + sign --}}
<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">
                Please review the loan deed below carefully, then sign at the bottom of the page.
            </p>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            {{-- The full deed document, read-only --}}
            ...
            {{-- Signing zone --}}
            <form method="POST"
                  action="{{ route('applications.loan-deed.sign', $application) }}"
                  id="loan-deed-sign-form">
                @csrf
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <label class="flex items-start gap-3 cursor-pointer">
                            ...
                            <span class="text-sm text-gray-700">
                                I confirm that I have read and understood the Loan Deed above, including the financial
                                table, fees, schedule and all operative provisions, and I agree to be bound by its terms.
                                I acknowledge this constitutes execution of the deed by electronic communication.
                            </span>
                        </label>
    ...
    <script>
        (function () {
            ...
            const form   = document.getElementById('loan-deed-sign-form');
