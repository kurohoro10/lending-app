{{-- resources/views/admin/applications/partials/show/borrower-directors.blade.php --}}
@php
            ...
            <table class="min-w-full divide-y divide-gray-200 text-sm" aria-label="{{ $label }}">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Ownership</th>
                        <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Guarantor</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-100">
                    @foreach($directors as $director)
                        <tr>
                            ...
                            <td class="px-4 py-3 text-gray-600">
                                {{ $director->date_of_birth?->format('d M Y') ?? '—' }}
                            </td>
