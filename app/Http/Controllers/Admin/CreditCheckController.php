...
{
    public function request(Request $request, Application $application)
    {
        ...
        // dispatch(new ProcessCreditCheck($creditCheck));

        return back()->with('success', 'Credit check requested successfully.');
    }

    public function update(Request $request, CreditCheck $creditCheck)
    {
        $validated = $request->validate([
    ...
    public function show(CreditCheck $creditCheck)
    {
